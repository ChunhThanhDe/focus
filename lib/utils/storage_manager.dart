...
class SharedPreferencesStorageManager extends LocalStorageManager {
  ...
  @override
  Future<bool> setDouble(String key, double value) async => prefs.setDouble(key, value);
  ...
  @override
  Future<bool> setBase64(String key, Uint8List value) => prefs.setString(key, base64.encode(value));
